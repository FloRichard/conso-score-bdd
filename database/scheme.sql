...
create table public.seller_stock (
    ...
    constraint pk_seller_stock primary key (seller_stock_id)
);
...
create table public.product (
    ...
    quantity_unity varchar(32) not null,
    tax int not null,
...
create table public.expedition_transport (
    ...
    name varchar(32) not null,
    kilometer_carbon_footprint int not null,
...
-- Seller foreign keys
alter table public.seller add
    constraint fk_seller_stock
        foreign key (seller_stock_id)
            references public.seller_stock (seller_stock_id)
                on delete cascade;


-- Maker foreign keys
alter table public.maker add
    constraint fk_maker_product
